...
def get_config():
    ...
    config.trainer = 'preprocess'  # 'train' or 'preprocess'
    ...
    config.preprocess.readdir = '/local/disk1/nacaFOAM/airfoilMNIST-raw'
    config.preprocess.writedir = '/local/temp/tjavaid/tffilescompactMaskedParallel'
